...
public class CraftAchievementMasterKiller extends GwAchievementBase implements AchievementMasterKiller {
    ...
    public CraftAchievementMasterKiller() {
        super("master_killer", TextReference.format("achievement.master_killer.name", "マスターキラー"),
                Arrays.asList(TextReference.format("achievement.master_killer.description", "1試合で50キル")), Material.DIAMOND_SWORD);
    }
